...
* [Portrait_of_Sir_Isaac_Newton,_1689.webp](https://commons.wikimedia.org/wiki/File:Portrait_of_Sir_Isaac_Newton,_1689_(brightened).jpg) by CactiStaccingCrane licensed [public domain](https://en.wikipedia.org/wiki/public_domain)
* [Opticks.webp](https://commons.wikimedia.org/wiki/File:Opticks.jpg) licensed [public domain](https://en.wikipedia.org/wiki/public_domain) - _Title page from the the first, 1704, edition of Opticks: or, A treatise of the reflexions, refractions, inflexions and colours of light. Also two treatises of the species and magnitude of curvilinear figures.
* [AdditiveColor.svg](https://commons.wikimedia.org/wiki/File:AdditiveColor.svg) by Mike Horvath licensed [public domain](https://en.wikipedia.org/wiki/en:public_domain) by [SharkD](https://en.wikipedia.org/wiki/User:SharkD) - *This image demonstrates the principle of additive color mixing, and is not meant as an exhibition of any particular color space.*
* [SubtractiveColor.svg](https://commons.wikimedia.org/wiki/File:SubtractiveColor.svg) by Mike Horvath licensed [public domain](https://en.wikipedia.org/wiki/en:public_domain) uploaded by [SharkD](https://en.wikipedia.org/wiki/User:SharkD) - *This image demonstrates the principle of subtractive color mixing, and is not meant as an exhibition of the CMYK color space.*
* [LCD pixels RGB.webp](https://commons.wikimedia.org/wiki/File:LCD_pixels_RGB.jpg) by Robnil01 licensed [public domain](https://en.wikipedia.org/wiki/en:public_domain) - *Pixels on LCD screen*
* [Farbkreis Itten 1961.svg](https://commons.wikimedia.org/wiki/File:Farbkreis_Itten_1961.svg) originally by [MalteAhrens](https://de.wikipedia.org/wiki/User:MalteAhrens) with vectorization by [SidShakal](https://commons.wikimedia.org/wiki/User:SidShakal) uploaded by [TMg](https://commons.wikimedia.org/wiki/User:TMg) licensed [public domain](https://en.wikipedia.org/wiki/en:public_domain) - *A representation of Johannes Itten's color wheel showing his red, yellow, and blue as primary colors within the central equilateral triangle.*
* [Isaac_Newton_signature_ws.svg](https://commons.wikimedia.org/wiki/File:Isaac_Newton_signature_ws.svg) uploaded by [Scewing](https://commons.wikimedia.org/wiki/User:Scewing) licensed [public domain](https://en.wikipedia.org/wiki/en:public_domain) - Signature of Isaac Newton from [Whipple Library](http://whipplelib.wordpress.com/2012/02/28/shelf-lives-origins-of-the-whipple/), University of Cambridge.
...
* [Cones SMJ2 E.svg](https://commons.wikimedia.org/wiki/File:Cones_SMJ2_E.svg) by [Vanessaezekowitz](https://en.wikipedia.org/wiki/User:Vanessaezekowitz) uploaded by [OgreBot](https://commons.wikimedia.org/wiki/User:OgreBot) licensed [CC SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/deed.en)
...
* [Visible spectrum 390-710 nm linear perceptual.svg](https://commons.wikimedia.org/wiki/File:Visible_spectrum_390-710_nm_linear_perceptual.svg) by [Bhutajata](https://commons.wikimedia.org/wiki/User:Bhutajata) licensed [CC SA BY 4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.en)
...
* [CIE1931xy gamut comparison.svg](https://commons.wikimedia.org/wiki/File:CIE1931xy_gamut_comparison.svg) by [BenRG](https://commons.wikimedia.org/wiki/User:BenRG) and [Cmglee](https://commons.wikimedia.org/wiki/User:Cmglee) licensed [CC SA BY 3.0](https://creativecommons.org/licenses/by-sa/3.0/deed.en)
  * Comparison of some RGB and CMYK colour gamut on a CIE 1931 xy chromaticity diagram, based on [CIE1931xy_blank.svg](https://commons.wikimedia.org/wiki/File:CIE1931xy_blank.svg) and data from Blatner and Fraser's "Real World Photoshop CS", p. 179: [Gamuts_comparison-B_F.webp](https://canopuscomputing.com.au/gallery2/d/8631-1/Gamuts_comparison-B_F.jpg).
  * 1931 CIE chromaticity diagram showing some RGB color spaces as defined by their chromaticity triangles
* [RGB Cube Show lowgamma cutout b.webp](https://commons.wikimedia.org/wiki/File:RGB_Cube_Show_lowgamma_cutout_b.png) by [SharkD](https://commons.wikimedia.org/wiki/User:SharkD) with [source](https://github.com/mjhorvath/mike_illustrations) licensed [CC SA BY 3.0](https://creativecommons.org/licenses/by-sa/3.0/deed.en)
...
* Ishihara color test test plates
  * [Ishihara_9.svg](https://commons.wikimedia.org/wiki/File:Ishihara_9.svg)  licensed [public domain](https://en.wikipedia.org/wiki/en:public_domain)
  * [Ishihara_1.svg](https://commons.wikimedia.org/wiki/File:Ishihara_1.svg)
  * Ishihara 11.png
* [Eyesensitivity.svg](https://commons.wikimedia.org/wiki/File:Eyesensitivity.svg) by Skatebiker, vector by [Adam Rędzikowski](https://commons.wikimedia.org/wiki/User:Adam_R%C4%99dzikowski) licensed [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0)
...
* [Linear_visible_spectrum.svg](https://commons.wikimedia.org/wiki/File:Linear_visible_spectrum.svg) by [Gringer](https://commons.wikimedia.org/wiki/User:Gringer) licensed [Public Domain](https://commons.wikimedia.org/wiki/File:Linear_visible_spectrum.svg?uselang=en#Licensing)
...
* [Cone-fundamentals-with-srgb-spectrum.svg](https://commons.wikimedia.org/wiki/File:Cone-fundamentals-with-srgb-spectrum.svg) by [BenRG](https://commons.wikimedia.org/wiki/User:BenRG) licensed [Public Domain](https://commons.wikimedia.org/wiki/File:Cone-fundamentals-with-srgb-spectrum.svg?uselang=en#Licensing)
